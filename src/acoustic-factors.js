const DEFINITIONS = [
  { id: "impactBody", group: "Impact shape", label: "Impact body", description: "Signed initial pressure response", defaultAmount: 0.18 },
  { id: "impactSoftness", group: "Impact shape", label: "Impact softness", description: "Rounds the initial pressure response", defaultAmount: 0.90 },
  ...
  { id: "wetMicrotexture", group: "Surface texture", label: "Wet microtexture", description: "Adds brief nonlinear high-frequency cusps inside each contact", defaultAmount: 0.35 },

const DEFINITIONS = [
  { id: "impactBody", group: "Impact shape", label: "Impact body", description: "Signed initial pressure response", defaultAmount: 0.08 },
  ...
  { id: "lowTexture", group: "Surface texture", label: "Low texture", description: "Independent low-frequency surface energy", defaultAmount: 0.90 },
